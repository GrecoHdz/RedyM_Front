            ...
            <div class="flex flex-col gap-2 relative">
              ...
              <div>
                <div class="flex items-center gap-1.5">
                  <h3 class="text-xs font-black text-gray-900 dark:text-white leading-tight uppercase text-nowrap">Predicciones</h3>
    ...
    try {
      ...
      if (err.name !== 'AbortError') {
        openExternal(`https://wa.me/?text=${encodeURIComponent(shareText)}`, {
          onOpen: () => console.log('🔗 [Dashboard] WhatsApp share fallback')
        })
      }
    }
  } else {
